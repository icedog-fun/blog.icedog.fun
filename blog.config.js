...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    '我是一名暂时有时间无聊和发疯的学生，我擅长不务正业，我们可以一起交流学习，共同...额...你带飞我躺吧🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '顾宁一', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '我是一名暂时有时间无聊和发疯的学生，我擅长不务正业，我们可以一起交流学习，共同...额...你带飞我躺吧', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.icedog.fun', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '顾宁一, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'gu2954@qq.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/image.png', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  MUSIC_PLAYER_METING_ID:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '3500353218', // 对应歌单的 id
  ...
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'icedog-fun/pinglun', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  COMMENT_GISCUS_REPO_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID || 'R_kgDOMS3gRg', // 你的Github Repo ID e.g ( 設定完 giscus 即可看到 )
  COMMENT_GISCUS_CATEGORY_ID:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'DIC_kwDOMS3gRs4CgnWa', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
  ...
  // 作废配置
  AVATAR: process.env.NEXT_PUBLIC_AVATAR || '/gu.jpg', // 作者头像，被notion中的ICON覆盖。若无ICON则取public目录下的avatar.png
  TITLE: process.env.NEXT_PUBLIC_TITLE || '顾宁一的博客', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/beijing.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '欢迎来到顾宁一的个人博客，这里是 HTML 技术交流的理想之地。我们分享有关如何免费搭建网站的技巧和教程，帮助您快速入门和掌握前端开发', // 站点描述，被notion中的页面描述覆盖
